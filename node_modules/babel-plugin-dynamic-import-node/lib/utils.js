...
function getImportSource(t, callNode) {
  ...
  return t.templateLiteral([t.templateElement({raw: '', cooked: ''}), t.templateElement({
    raw: '',
    cooked: ''
...
function createDynamicImportTransform(_ref) {
  ...
  return function (context, path) {
    ...
    var newImport = context.opts.noInterop ? builder.noInterop({SOURCE: SOURCE}) : builder.interop({
      SOURCE: SOURCE,
