...
<div id="chart_container" style="width: 400px; height: 220px; border: 1px solid #808080;">
  <svg:svg id="chart_container" height="220" width="400">
    ...
    <svg:g>
      ...
      <svg:text fill="black" font-weight="bold" font-size="10" font-family="Arial" y="16" x="200" text-anchor="middle">
        Test Chart
      </svg:text>
      ...
      <svg:text fill="black" font-size="12" font-family="Arial" y="94" x="318" onclick="markClick('text_apple')">Apple
      </svg:text>
  ...
  <div
    style="position: absolute; white-space: nowrap; top: 230px; left: 410px; font-family: Arial; font-size: 12px; display: none; ">
    WOrange
  </div>
</div>
<div
  style="display: none; position: absolute; top: 230px; left: 410px; white-space: nowrap; font-family: Arial; font-size: 12px;">
  WOrange
</div>
</body>
</html>
