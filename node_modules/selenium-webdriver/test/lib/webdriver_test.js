    ...
    enablePromiseManager(() => {
      ...
      describe('creation failures bubble up in control flow', function () {
        ...
        it('onQuit callback failure suppress creation failure', function () {
          ...
          WebDriver.createSession(
            executor, {'browserName': 'firefox'}, null, () => {
              throw e
            });
  ...
  describe('findElement', function () {
      ...
      let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
        {
          using: 'css selector',
          value: '*[id="foo"]'
        }).andReturnSuccess(WebElement.buildId('bar')).expect(CName.CLICK_ELEMENT, {'id': WebElement.buildId('bar')}).andReturnSuccess().end();
    ...
    it('customLocator', function () {
      let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS, {
        ...
        WebElement.buildId('bar')]).expect(CName.CLICK_ELEMENT, {'id': WebElement.buildId('foo')}).andReturnSuccess().end();
