...
(function (global, factory) {
  ...
  function waitForMap(obj, fn) {
    ...
    forEach(obj, function (a, k) {
      var mapped = fn(k, a).pipe(operators.map(function (r) {
        return res[k] = r;
      }));
      if (k === PRIMARY_OUTLET) {
    ...
    return rxjs.of.apply(null, waitHead.concat(waitTail))
      .pipe(operators.concatAll(), operators.last(), operators.map(function () {
        return res;
      }));
  }
  ...
  var ActivatedRoute = /** @class */ (function () {
    ...
    Object.defineProperty(ActivatedRoute.prototype, "paramMap", {
      ...
      get: function () {
        if (!this._paramMap) {
          this._paramMap = this.params.pipe(operators.map(function (p) {
    ...
    Object.defineProperty(ActivatedRoute.prototype, "queryParamMap", {
      ...
      get: function () {
        if (!this._queryParamMap) {
          this._queryParamMap =
            this.queryParams.pipe(operators.map(function (p) {
              return convertToParamMap(p);
            }));
        }
        return this._queryParamMap;
  ...
  var ApplyRedirects = /** @class */ (function () {
    ...
    ApplyRedirects.prototype.expandSegmentGroup = function (ngModule, routes, segmentGroup, outlet) {
      if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
        return this.expandChildren(ngModule, routes, segmentGroup)
          .pipe(operators.map(function (children) {
    ...
    ApplyRedirects.prototype.expandSegment = function (ngModule, segmentGroup, routes, segments, outlet, allowRedirects) {
      ...
      }), operators.concatAll(), operators.first(function (s) {
        return !!s;
      }), operators.catchError(function (e, _) {
    ...
    ApplyRedirects.prototype.matchSegmentAgainstRoute = function (ngModule, rawSegmentGroup, route, segments) {
      ...
      return childConfig$.pipe(operators.mergeMap(function (routerConfig) {
        ...
        if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
          ...
          return expanded$_1.pipe(operators.map(function (children) {
    ...
    ApplyRedirects.prototype.runCanLoadGuards = function (moduleInjector, route, segments) {
      ...
      return obs.pipe(operators.concatAll(), operators.tap(function (result) {
        ...
        error.url = result;
        throw error;
      }), operators.every(function (result) {
        return result === true;
      }));
    };
  ...
  function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
    return function (source) {
      return source.pipe(operators.switchMap(function (t) {
        return applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config)
          .pipe(operators.map(function (urlAfterRedirects) {
            return (__assign(__assign({}, t), {urlAfterRedirects: urlAfterRedirects}));
          }));
      }));
    };
  }
  ...
  function prioritizedGuardValue() {
    return operators.switchMap(function (obs) {
      return rxjs.combineLatest.apply(void 0, __spread(obs.map(function (o) {
        return o.pipe(operators.take(1), operators.startWith(INITIAL_VALUE));
        ...
        }, INITIAL_VALUE), operators.filter(function (item) {
    ...
    return function (source) {
      return source.pipe(operators.mergeMap(function (t) {
        ...
        return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector)
          ...
          }), operators.map(function (guardsResult) {
            return (__assign(__assign({}, t), {guardsResult: guardsResult}));
          }));
      }));
    };
  }
    ...
    return function (source) {
      return source.pipe(operators.mergeMap(function (t) {
        return recognize(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution)
          .pipe(operators.map(function (targetSnapshot) {
            return (__assign(__assign({}, t), {targetSnapshot: targetSnapshot}));
          }));
      }));
    };
  }
    ...
    return function (source) {
      return source.pipe(operators.mergeMap(function (t) {
        ...
        return rxjs.from(canActivateChecks)
          ...
          }), operators.takeLast(1), operators.mergeMap(function (_) {
            return canActivateChecksResolved === canActivateChecks.length ? rxjs.of(t) : rxjs.EMPTY;
          }));
      }));
    };
  }
  ...
  function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
    ...
    var data = {};
    return rxjs.from(keys).pipe(operators.mergeMap(function (key) {
  ...
  function switchTap(next) {
    return function (source) {
      return source.pipe(operators.switchMap(function (v) {
        ...
        if (nextResult) {
          return rxjs.from(nextResult).pipe(operators.map(function () {
            return v;
          }));
        }
        return rxjs.from([v]);
  ...
  var Router = /** @class */ (function () {
    ...
    Router.prototype.setupNavigations = function (transitions) {
      ...
      return transitions.pipe(operators.filter(function (t) {
          return t.id !== 0;
        }),
        // Extract URL
        ...
        operators.switchMap(function (t) {
          ...
          return rxjs.of(t).pipe(
            ...
            operators.tap(function (t) {
              ...
              if (processCurrentUrl) {
                ...
                if (processPreviousUrl) {
                  ...
                  return rxjs.of(__assign(__assign({}, t), {
                    targetSnapshot: targetSnapshot,
                    urlAfterRedirects: extractedUrl,
                    extras: __assign(__assign({}, extras), {skipLocationChange: false, replaceUrl: false})
                  }));
                } else {
            ...
            operators.tap(function (t) {
              ...
              return (__assign(__assign({}, t), {guards: getAllRouteGuards(t.targetSnapshot, t.currentSnapshot, _this.rootContexts)}));
              ...
              if (isNavigationCancelingError(e)) {
                ...
                if (!redirecting) {
                  ...
                  setTimeout(function () {
                    ...
                    return _this.scheduleNavigation(mergedTree, 'imperative', null, extras, {
                      resolve: t.resolve,
                      reject: t.reject,
                      promise: t.promise
                    });
  ...
  var PreloadAllModules = /** @class */ (function () {
    ...
    PreloadAllModules.prototype.preload = function (route, fn) {
      return fn().pipe(operators.catchError(function () {
        return rxjs.of(null);
      }));
    };
  ...
  var RouterPreloader = /** @class */ (function () {
    ...
    RouterPreloader.prototype.processRoutes = function (ngModule, routes) {
      ...
      return rxjs.from(res).pipe(operators.mergeAll(), operators.map(function (_) {
        return void 0;
      }));
    };
