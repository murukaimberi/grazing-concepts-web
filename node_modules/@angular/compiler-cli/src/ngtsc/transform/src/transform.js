...
(function (factory) {
    ...
    IvyVisitor.prototype.visitClassDeclaration = function (node) {
      ...
      if (res !== null) {
        ...
        res.forEach(function (field) {
          ...
          field.statements
            .map(function (stmt) {
              return translator_1.translateStatement(stmt, _this.importManager, _this.defaultImportRecorder, ts.ScriptTarget.ES2015);
            })
            .forEach(function (stmt) {
              return statements_1.push(stmt);
            });
  ...
  function transformIvySourceFile(compilation, context, reflector, importRewriter, file, isCore, isClosureCompilerEnabled, defaultImportRecorder) {
    ...
    var constants = constantPool.statements.map(function (stmt) {
      return translator_1.translateStatement(stmt, importManager, defaultImportRecorder, getLocalizeCompileTarget(context));
    });
