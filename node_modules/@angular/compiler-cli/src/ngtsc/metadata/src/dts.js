...
(function (factory) {
  ...
  var DtsMetadataReader = /** @class */ (function () {
    ...
    DtsMetadataReader.prototype.getNgModuleMetadata = function (ref) {
      ...
      var _a = tslib_1.__read(ngModuleDef.type.typeArguments, 4), _ = _a[0], declarationMetadata = _a[1],
        importMetadata = _a[2], exportMetadata = _a[3];
      return {
        ref: ref,
    ...
    DtsMetadataReader.prototype.getDirectiveMetadata = function (ref) {
      ...
      return tslib_1.__assign(tslib_1.__assign({
        ...
        inputs: util_1.readStringMapType(def.type.typeArguments[3]),
        outputs: util_1.readStringMapType(def.type.typeArguments[4]),
        queries: util_1.readStringArrayType(def.type.typeArguments[5])
      }, util_1.extractDirectiveGuards(clazz, this.reflector)), {baseClass: readBaseClass(clazz, this.checker, this.reflector)});
    };
    /**
