...
(function (factory) {
  ...
  var NgCompiler = /** @class */ (function () {
    function NgCompiler(adapter, options, tsProgram, typeCheckingProgramStrategy, incrementalStrategy, oldProgram, perfRecorder) {
      ...
      if (perfRecorder === void 0) {
        perfRecorder = perf_1.NOOP_PERF_RECORDER;
      }
      ...
      var moduleResolutionCache = ts.createModuleResolutionCache(this.adapter.getCurrentDirectory(), function (fileName) {
        return _this.adapter.getCanonicalFileName(fileName);
      });
      this.moduleResolver =
      ...
      this.ignoreForDiagnostics =
        new Set(tsProgram.getSourceFiles().filter(function (sf) {
            ...
            case 0:
              ...
              _loop_1 = function (sf) {
                ...
                if (analysisPromise === undefined) {
                  ...
                  analysisPromise = analysisPromise.then(function () {
                    return _this.perfRecorder.stop(analyzeFileSpan);
                  });
                }
                if (analysisPromise !== undefined) {
  ...
  function isAngularCorePackage(program) {
    ...
    return r3Symbols.statements.some(function (stmt) {
      ...
      if (stmt.modifiers === undefined ||
        !stmt.modifiers.some(function (mod) {
