(function (factory) {
    ...
    FactoryGenerator.prototype.generateShimForFile = function (sf, genFilePath) {
      ...
      var symbolNames = sf.statements
        ...
        .filter(function (decl) {
          return isExported(decl) && decl.decorators !== undefined &&
            decl.name !== undefined;
        })
  ...
  function isExported(decl) {
    return decl.modifiers !== undefined &&
      decl.modifiers.some(function (mod) {
  ...
  function transformFactorySourceFile(factoryMap, context, importRewriter, file) {
    ...
    var _b = factoryMap.get(file.fileName), moduleSymbolNames = _b.moduleSymbolNames,
      sourceFilePath = _b.sourceFilePath;
