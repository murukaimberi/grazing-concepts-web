    ...
    topLevelExports.forEach(function (mainExport) {
      ...
      refGraph.transitiveReferencesOf(mainExport).forEach(function (transitiveReference) {
        ...
        if (!topLevelExports.has(transitiveReference)) {
          ...
          }, getPosOfDeclaration(transitiveReference)), {messageText: "Unsupported private " + descriptor + " " + name_1 + ". This " + descriptor + " is visible to consumers via " + visibleVia + ", but is not exported from the top-level library entrypoint."});
