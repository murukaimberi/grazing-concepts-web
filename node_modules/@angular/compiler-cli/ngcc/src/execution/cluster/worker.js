  ...
  if (require.main === module) {
    (function () {
      return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var _a, logger, pathMappings, enableI18nLegacyMessageIdFormat, fileSystem, tsConfig, getFileWriter,
          pkgJsonUpdater, fileWriter, createCompileFn, e_1;
  ...
  function startWorker(logger, createCompileFn) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        ...
        compile = createCompileFn(function (transformedFiles) {
          return utils_2.sendMessageToMaster({
            type: 'transformed-files',
            files: transformedFiles.map(function (f) {
              return f.path;
            }),
          });
        }, function (_task, outcome, message) {
          ...
          return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
              switch (_c.label) {
                ...
                case 7:
                  return [4 /*yield*/, utils_2.sendMessageToMaster({
                    type: 'error',
