(function (factory) {
  ...
  var ProcessedNgccPackageConfig = /** @class */ (function () {
    function ProcessedNgccPackageConfig(packagePath, _a) {
      var _b = _a.entryPoints, entryPoints = _b === void 0 ? {} : _b, _c = _a.ignorableDeepImportMatchers,
  ...
  var NgccConfiguration = /** @class */ (function () {
    ...
    NgccConfiguration.prototype.processProjectConfig = function (projectConfig) {
      ...
      for (var packageNameAndVersion in projectConfig.packages) {
        ...
        if (packageConfig) {
          var _a = tslib_1.__read(this.splitNameAndVersion(packageNameAndVersion), 2), packageName = _a[0], _b = _a[1],
  ...
  function findSatisfactoryVersion(configs, version) {
    ...
    return configs.find(function (config) {
        return semver_1.satisfies(version, config.versionRange, {includePrerelease: true});
      }) ||
      null;
  }
});
