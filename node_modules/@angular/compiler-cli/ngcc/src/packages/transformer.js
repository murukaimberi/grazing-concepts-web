(function (factory) {
  ...
  var Transformer = /** @class */ (function () {
    ...
    Transformer.prototype.transform = function (bundle) {
      ...
      var _a = this.analyzeProgram(reflectionHost, bundle), decorationAnalyses = _a.decorationAnalyses,
        switchMarkerAnalyses = _a.switchMarkerAnalyses, privateDeclarationsAnalyses = _a.privateDeclarationsAnalyses,
        moduleWithProvidersAnalyses = _a.moduleWithProvidersAnalyses, diagnostics = _a.diagnostics;
    ...
    Transformer.prototype.analyzeProgram = function (reflectionHost, bundle) {
      ...
      var diagnostics = [];
      var decorationAnalyzer = new decoration_analyzer_1.DecorationAnalyzer(this.fs, bundle, reflectionHost, referencesRegistry, function (diagnostic) {
