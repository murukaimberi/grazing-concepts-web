(function (factory) {
  ...
  var SourceFile = /** @class */ (function () {
    ...
    SourceFile.prototype.renderFlattenedSourceMap = function () {
      ...
      var sourceMap = {
        ...
        sources: sources.map(function (sf) {
          return file_system_1.relative(sourcePathDir, sf.sourcePath);
        }),
        names: names,
        mappings: sourcemap_codec_1.encode(mappings),
        sourcesContent: sources.map(function (sf) {
          return sf.contents;
        }),
      };
      return sourceMap;
  ...
  function extractOriginalSegments(mappings) {
    ...
    originalSegments.forEach(function (segmentMarkers) {
      return segmentMarkers.sort(segment_marker_1.compareSegments);
    });
