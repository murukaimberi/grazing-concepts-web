...
(function (factory) {
  ...
  var DependencyResolver = /** @class */ (function () {
    ...
    DependencyResolver.prototype.sortEntryPointsByDependency = function (entryPoints, target) {
      var _a = this.computeDependencyGraph(entryPoints), invalidEntryPoints = _a.invalidEntryPoints,
        ignoredDependencies = _a.ignoredDependencies, graph = _a.graph;
    ...
    DependencyResolver.prototype.computeDependencyGraph = function (entryPoints) {
      ...
      angularEntryPoints.forEach(function (_a) {
        var entryPoint = _a.entryPoint, _b = _a.depInfo, dependencies = _b.dependencies, missing = _b.missing,
