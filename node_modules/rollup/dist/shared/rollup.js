...
function parseInputOptions(config, overrides = {
  external: [],
  globals: undefined
...
function loadFsEvents() {
  return Promise.resolve().then(function () {
    return _interopNamespace(require('fsevents'));
  })
    .then(namespace => {
  ...
  return (plugin, pidx) => {
    ...
    const context = {
      ...
      emitAsset: getDeprecatedContextHandler((name, source) => fileEmitter.emitFile({
        ...
        name,
        source
      }), 'emitAsset', 'emitFile', plugin.name, true, graph),
      emitChunk: getDeprecatedContextHandler((id, options) => fileEmitter.emitFile({
        type: 'chunk',
        id,
        name: options && options.name
      }), 'emitChunk', 'emitFile', plugin.name, true, graph),
...
function watch(configs) {
  ...
  loadFsEvents()
    .then(() => Promise.resolve().then(function () {
