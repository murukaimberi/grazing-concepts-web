...
function parseJsDocWorker(node, sourceFile, considerTrailingComments) {
    ...
    var start = ts[considerTrailingComments && isSameLine(sourceFile, node.pos, nodeStart)
        ...
        : 'forEachLeadingCommentRange'](sourceFile.text, node.pos, function (pos, _end, kind) {
        return kind === ts.SyntaxKind.MultiLineCommentTrivia && sourceFile.text[pos + 2] === '*' ? {pos: pos} : undefined;
    });
    if (start === undefined)
        return [];
    ...
    function updateNode(n, parent) {
        ...
        n.end += startPos;
        n.parent = parent;
        return ts.forEachChild(n, function (child) {
            return updateNode(child, n);
        }, function (children) {
