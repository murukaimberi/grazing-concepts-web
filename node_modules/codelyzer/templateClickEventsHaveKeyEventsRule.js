...
var TemplateVisitorCtrl = (function (_super) {
  ...
  TemplateVisitorCtrl.prototype.validateElement = function (el) {
    var hasClick = el.outputs.some(function (output) {
      return output.name === 'click';
    });
    if (!hasClick) {
      return;
    }
    ...
    var hasKeyEvent = el.outputs.some(function (output) {
      return output.name.startsWith('keyup') || output.name.startsWith('keydown') || output.name.startsWith('keypress');
    });
    if (hasKeyEvent) {
      return;
    }
