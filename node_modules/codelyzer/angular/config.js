...
var transform = function (code, fileExtensions, url) {
  var parsedCode = !url || fileExtensions.some(function (fileExtension) {
    return url.endsWith(fileExtension);
  }) ? code : '';
...
exports.Config = {
  ...
  transformStyle: function (code, url) {
    return transform(code, [CSS_FILE_EXTENSION], url);
  },
  transformTemplate: function (code, url) {
    return transform(code, [HTML_FILE_EXTENSION, SVG_FILE_EXTENSION], url);
  }
};
try {
