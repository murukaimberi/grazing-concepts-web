...
exports.getFailureMessage = function (failureParameters) {
  return sprintf_js_1.sprintf(failureParameters.message);
};
...
var validateMethods = function (context, node) {
  ...
  var hasConflictingLifecycle = LIFECYCLE_METHODS.every(function (lifecycleMethod) {
    return declaredAngularLifecycleMethods.includes(lifecycleMethod);
  });
  if (!hasConflictingLifecycle)
    return;
  var failure = exports.getFailureMessage({
