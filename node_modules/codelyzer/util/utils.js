...
exports.getDecoratorPropertyInitializer = function (decorator, name) {
  ...
  var property = properties.find(function (prop) {
    return !!(prop.name && typescript_1.isIdentifier(prop.name) && prop.name.text === name);
  });
...
exports.getComponentDecorator = function (node) {
  return exports.getDecorator(node, 'Component');
};
exports.getDirectiveDecorator = function (node) {
  return exports.getDecorator(node, 'Directive');
};
exports.getInjectableDecorator = function (node) {
  return exports.getDecorator(node, 'Injectable');
};
exports.getNgModuleDecorator = function (node) {
  return exports.getDecorator(node, 'NgModule');
};
exports.getPipeDecorator = function (node) {
  return exports.getDecorator(node, 'Pipe');
};
...
exports.getDeclaredInterfaces = function (node) {
  var heritageClause = typescript_1.createNodeArray(node.heritageClauses).find(function (h) {
    return h.token === typescript_1.SyntaxKind.ImplementsKeyword;
  });
  return heritageClause ? heritageClause.types : typescript_1.createNodeArray([]);
};
exports.getDeclaredInterfaceNames = function (node) {
  return exports.getDeclaredInterfaces(node).map(exports.getSymbolName);
};
exports.getDeclaredInterfaceName = function (node, value) {
  return exports.getDeclaredInterfaceNames(node).find(function (interfaceName) {
...
exports.kebabToCamelCase = function (value) {
  return value.replace(/-[a-zA-Z]/g, function (x) {
...
exports.toTitleCase = function (value) {
  return value.replace(unicodeWordMatch, function (val) {
