...
var TemplateVisitorCtrl = (function (_super) {
  ...
  TemplateVisitorCtrl.prototype.validateElement = function (el) {
    var hasMouseOver = el.outputs.some(function (output) {
      return output.name === 'mouseover';
    });
    var hasMouseOut = el.outputs.some(function (output) {
      return output.name === 'mouseout';
    });
    var hasFocus = el.outputs.some(function (output) {
      return output.name === 'focus';
    });
    var hasBlur = el.outputs.some(function (output) {
      return output.name === 'blur';
    });
