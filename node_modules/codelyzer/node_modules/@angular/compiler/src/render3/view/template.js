...
(function (factory) {
  ...
  var TemplateDefinitionBuilder = /** @class */ (function () {
    ...
    TemplateDefinitionBuilder.prototype.i18nFormatPlaceholderNames = function (params, useCamelCase) {
      ...
      if (params && Object.keys(params).length) {
        Object.keys(params).forEach(function (key) {
          return _params[util_3.formatI18nPlaceholderName(key, useCamelCase)] = params[key];
        });
      }
      return _params;
    };
              ...
              if (converted instanceof ast_1.Interpolation) {
                ...
                converted.expressions.forEach(function (expression) {
                  ...
                  bindings_1.push({
                    ...
                    value: function () {
                      return _this.convertExpressionBinding(expression);
                    }
                  });
                });
              }
    ...
    TemplateDefinitionBuilder.prototype.visitTemplate = function (template) {
      ...
      template.attributes.forEach(function (a) {
        attrsExprs.push(util_4.asLiteral(a.name), util_4.asLiteral(a.value));
      });
    ...
    TemplateDefinitionBuilder.prototype.visitBoundText = function (text) {
      ...
      if (value instanceof ast_1.Interpolation) {
        ...
        this.updateInstruction(nodeIndex, text.sourceSpan, r3_identifiers_1.Identifiers.textBinding, function () {
          return [_this.convertPropertyBinding(value)];
        });
      }
    };
  ...
  function parseTemplate(template, templateUrl, options) {
    ...
    var _a = r3_template_transform_1.htmlAstToRender3Ast(rootNodes, bindingParser), nodes = _a.nodes,
      errors = _a.errors, styleUrls = _a.styleUrls, styles = _a.styles;
