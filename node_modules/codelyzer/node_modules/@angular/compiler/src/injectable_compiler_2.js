  ...
  function compileInjectable(meta) {
    ...
    if (meta.useClass !== undefined) {
      ...
      if (deps !== undefined) {
        ...
        result = r3_factory_1.compileFactoryFunction(tslib_1.__assign({}, factoryMeta, {
        ...
        result = r3_factory_1.compileFactoryFunction(tslib_1.__assign({}, factoryMeta, {
          delegate: meta.useClass,
          delegateType: r3_factory_1.R3FactoryDelegateType.Factory
        }));
      }
    ...
    var expression = o.importExpr(identifiers_1.Identifiers.ɵɵdefineInjectable).callFn([util_1.mapToMapExpression({
      token: token,
