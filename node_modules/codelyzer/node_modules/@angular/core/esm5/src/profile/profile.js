 ...
 */
export var wtfCreateScope = wtfEnabled ? createScope : function (signature, flags) {
  return noopScope;
};
/**
 ...
 * @deprecated the Web Tracing Framework is no longer supported in Angular
 */
export var wtfLeave = wtfEnabled ? leave : function (s, r) {
  return r;
};
/**
 ...
 * @deprecated the Web Tracing Framework is no longer supported in Angular
 */
export var wtfStartTimeRange = wtfEnabled ? startTimeRange : function (rangeType, action) {
  return null;
};
/**
 ...
 * @deprecated the Web Tracing Framework is no longer supported in Angular
 */
export var wtfEndTimeRange = wtfEnabled ? endTimeRange : function (r) {
  return null;
};
