...
var NoUnsafeAnyWalker = /** @class */ (function (_super) {
  ...
  function NoUnsafeAnyWalker(sourceFile, ruleName, checker) {
    ...
    _this.visitNodeCallback = function (node) {
      return void _this.visitNode(node);
    };
    return _this;
  }
  ...
  NoUnsafeAnyWalker.prototype.visitNode = function (node, anyOk) {
    switch (node.kind) {
      ...
      case ts.SyntaxKind.ForStatement: {
        var _q = node, initializer = _q.initializer, condition = _q.condition, incrementor = _q.incrementor,
