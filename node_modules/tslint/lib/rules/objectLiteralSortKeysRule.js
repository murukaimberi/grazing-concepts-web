...
function walk(ctx, checker) {
  var sourceFile = ctx.sourceFile, _a = ctx.options, ignoreBlankLines = _a.ignoreBlankLines, ignoreCase = _a.ignoreCase,
    localeCompare = _a.localeCompare, matchDeclarationOrder = _a.matchDeclarationOrder,
    matchDeclarationOrderOnly = _a.matchDeclarationOrderOnly, shorthandFirst = _a.shorthandFirst;
