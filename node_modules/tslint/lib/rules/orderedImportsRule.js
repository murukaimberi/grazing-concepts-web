...
var TRANSFORMS = new Map([
  ...
  ["case-insensitive-legacy", function (x) {
...
function parseOptions(ruleArguments) {
  ...
  var _a = optionSet === undefined ? {} : optionSet, _b = _a["grouped-imports"], isGrouped = _b === void 0 ? false : _b,
    _c = _a["import-sources-order"], sources = _c === void 0 ? "case-insensitive" : _c, _d = _a["named-imports-order"],
    named = _d === void 0 ? "case-insensitive" : _d, _e = _a["module-source-path"], path = _e === void 0 ? "full" : _e,
    _f = _a.groups, groups = _f === void 0 ? defaultGroups : _f;
...
var Walker = /** @class */ (function (_super) {
  ...
  Walker.prototype.checkBlocksGrouping = function () {
    ...
    var addFailingImportDecl = function (decl) {
      var groupsMsg = tslib_1.__spreadArrays(_this.options.groups).sort(function (a, b) {
    ...
    var blocksWithContent = this.importsBlocks.filter(function (b) {
      return b.getImportDeclarations().length > 0;
    });
  ...
  Walker.prototype.getGroupOrderReplacements = function () {
    ...
    var groupedDeclarations = this.importsBlocks
      .map(function (block) {
        return block.getImportDeclarations();
      })
  ...
  Walker.prototype.getGroupedImports = function (importDeclarations) {
    ...
    return orderValues
      .map(function (curOrder) {
        var imports = importDeclarations.filter(function (i) {
          return i.group.order === curOrder;
        });
...
function getSortedImportDeclarationsAsText(importDeclarations) {
  var sortedDeclarations = sortByKey(importDeclarations.slice(), function (x) {
    return x.importPath;
  });
  return sortedDeclarations.map(function (x) {
    return x.text;
  }).join("");
}
