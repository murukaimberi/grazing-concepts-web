...
function walk(ctx, program) {
  var sourceFile = ctx.sourceFile, _a = ctx.options, checkParameters = _a.checkParameters,
  ...
  var imports = forEachImport(sourceFile, function (i) {
    ...
    if (i.kind === ts.SyntaxKind.ImportEqualsDeclaration) {
      ...
      if (kind === 2 /* DECLARATION */) {
        ...
        if (namedBindings !== undefined) {
          imp.push.apply(imp, namedBindings.elements.map(function (el) {
            return el.name;
          }));
        }
...
function makeUnusedCheckedProgram(program, checkParameters) {
  ...
  var options = tslib_1.__assign(tslib_1.__assign({}, originalOptions), {
    noEmit: true,
    noUnusedLocals: true,
