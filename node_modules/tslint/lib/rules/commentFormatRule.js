...
function parseOptions(options) {
  return tslib_1.__assign({
    allowTrailingLowercase: has(OPTION_ALLOW_TRAILING_LOWERCASE), case: options.indexOf(OPTION_LOWERCASE) !== -1
      ? 1 /* Lower */
      : options.indexOf(OPTION_UPPERCASE) !== -1
        ? 2 /* Upper */
        : 0 /* None */, failureSuffix: "", space: has(OPTION_SPACE)
  ...
  CommentFormatWalker.prototype.checkComment = function (fullText, _a) {
    ...
    if (kind !== ts.SyntaxKind.SingleLineCommentTrivia ||
      ...
      (fullText[status.start] === "/" &&
        this.sourceFile.referencedFiles.some(function (ref) {
