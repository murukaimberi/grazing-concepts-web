...
var Rule = /** @class */ (function (_super) {
  ...
  Rule.prototype.getRuleOptions = function () {
    ...
    if (typeof argument === "number") {
      ...
      var _a = argument, _b = OPTION_CHECK_REGEX, checkRegex = _a[_b], _c = OPTION_CHECK_STRINGS, checkStrings = _a[_c],
        _d = OPTION_IGNORE_PATTERN, ignorePattern = _a[_d], _e = OPTION_LIMIT, limit = _a[_e];
      return {
...
function shouldIgnoreLine(_a, _b) {
  ...
  var checkRegex = options.checkRegex, checkStrings = options.checkStrings, ignorePattern = options.ignorePattern,
    limit = options.limit;
