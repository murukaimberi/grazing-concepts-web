...
function findup(filenames, directory) {
  ...
  function findFile(cwd) {
    ...
    var _loop_1 = function (filename) {
      ...
      var result = dirFiles.find(function (entry) {
        return entry.toLowerCase() === filename;
      });
      if (result !== undefined) {
...
function isFileExcluded(filepath, configFile) {
  ...
  return configFile.linterOptions.exclude.some(function (pattern) {
    return new minimatch_1.Minimatch(pattern).match(fullPath);
  });
}
