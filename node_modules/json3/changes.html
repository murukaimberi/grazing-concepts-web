...
<div id="content">
  ...
  <ul>
    ...
    <li>Include the minified version in the npm package [<a href="https://github.com/bestiejs/json3/issues/59">#59</a>].
    </li>
  ...
  <ul>
    ...
    <li>Make <code>JSON3.noConflict()</code> idempotent [<a href="https://github.com/bestiejs/json3/issues/56">#56</a>].
    </li>
  ...
  <ul>
    <li>Use <code>object.hasOwnProperty(prop)</code> instead of <code>Object#hasOwnProperty.call(object, prop)</code>
      when iterating over host objects [<a href="https://github.com/bestiejs/json3/issues/18">#18</a>].
    </li>
    <li>Minification improvements; avoid munging the AMD <code>define</code> pragma [<a
      href="https://github.com/bestiejs/json3/issues/22">#22</a>; <a href="https://github.com/bestiejs/json3/pull/25">#25</a>].
    </li>
    <li>Use character codes instead of strings in <code>lex()</code>. Optimize for valid source strings [<a
      href="https://github.com/bestiejs/json3/issues/23">#23</a>; <a href="https://github.com/bestiejs/json3/pull/27">#27</a>].
    </li>
    ...
    <li>Handle serializing ExtendScript host objects that throw exceptions [<a
      href="https://github.com/bestiejs/json3/issues/30">#30</a>; <a href="https://github.com/bestiejs/json3/pull/31">#31</a>].
    </li>
  ...
  <ul>
    ...
    <li>Isolate the feature tests into a <code>has()</code> function for <a href="https://github.com/phiggins42/has.js"><code>has.js</code></a>
      compatibility [<a href="https://github.com/bestiejs/json3/issues/19">#19</a>].
    </li>
  </ul>
  ...
  <ul>
    ...
    <li><code>parse()</code>: Use <code>delete</code> instead of <code>Array#splice()</code> when removing elements from
      traversed arrays [<a href="https://github.com/bestiejs/json3/issues/10">#10</a>].
    </li>
  ...
  <ul>
    <li>Reduce the file size by removing parse error strings [<a
      href="https://github.com/bestiejs/json3/issues/5">#5</a>].
    </li>
  ...
  <ul>
    ...
    <li>Add a workaround for buggy <code>Date#getUTC{FullYear, Month, Date}</code> implementations in Opera &gt; 9.64
      [<a href="https://github.com/bestiejs/json3/issues/4">#4</a>].
    </li>
  ...
  <ul>
    <li>Avoided relying on native functions <code>Math.abs</code>, and <code>isFinite</code>, and native constructors
      <code>String</code>, <code>Number</code>, <code>Object</code>, and <code>Array</code></li>
