...
function MetricCells({metrics}) {
  ...
  return (
    < >
    < td
  className = {'pct ' +classForPercent} > {Math.round(pct)} % < /td>
    < td
  className = {classForPercent} >
    < div
  className = "bar" >
    < div
...
><
  ...
  < /td>
  < td
  className = {'abs ' +classForPercent} > {covered} < /td>
    < td
  className = {'abs ' +classForPercent} > {total} < /td>
    < />
)
  ;
}
...
<
  ...
  {
    metricsToShow.lines && < MetricCells
