...
(function (factory) {
  ...
  Zone.__load_patch('rxjs.Scheduler.now', function (global, Zone, api) {
    api.patchMethod(rxjs_1.Scheduler, 'now', function (delegate) {
      return function (self, args) {
        return Date.now.call(self);
      };
    });
    api.patchMethod(rxjs_1.asyncScheduler, 'now', function (delegate) {
      return function (self, args) {
        return Date.now.call(self);
      };
    });
    api.patchMethod(rxjs_1.asapScheduler, 'now', function (delegate) {
      return function (self, args) {
        return Date.now.call(self);
      };
    });
