...
(function (factory) {
  ...
  Zone.__load_patch('XHR', function (global, Zone) {
    ...
    function patchXHR(window) {
      ...
      var openNative = utils_1.patchMethod(XMLHttpRequestPrototype, 'open', function () {
      ...
      var sendNative = utils_1.patchMethod(XMLHttpRequestPrototype, 'send', function () {
        return function (self, args) {
      ...
      var abortNative = utils_1.patchMethod(XMLHttpRequestPrototype, 'abort', function () {
        return function (self, args) {
